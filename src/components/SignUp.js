...
export default function SignUp() {
    ...
    const handleSubmit = (e) => {
      ...
      setFormErrors(validate(formValues));
       ...
       let index = data.findIndex(
        (toFind) =>
          toFind.username === formValues.username && toFind.password === formValues.password
       );
       if(index > -1){
    ...
    const validate = (values) => {
      ...
      if (!values.password) {
        const text= <p>*Password is required <br></br>*Password must be more than 4 character and less than 10 characters <br></br>*Password should contain atleast one special character,one number,one lowercase and uppercase letter </p>;
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="ui form">
         ...
         <div className="ui signinlink">
          <p className="para-2">Already have an account ?<a href="#" onClick={handleClickOnSignIn}> Sign In</a></p>
         </div>
        </div>
      </form>
